...
#+begin_src emacs-lisp :task yes :doc "Export documentation" :shebang "#!/usr/bin/env emacs --script"
  ...
  (setq org-publish-project-alist
        '(
          ("nace-lookup" :components ("nace-lookup.org" "nace-lookup.attachments" "nace-lookup.assets" "nace-lookup.data" "nace-lookup.web"))
          ("bm.org"
           :base-directory "."
           ...
           :auto-preamble f)
          ("bm.attachments"
           :base-directory "attachments"
           :publishing-directory "output/doc/attachments"
           :base-extension "png\\|jpg\\|pdf\\|json"
           :recursive t
           :publishing-function org-publish-attachment)
          ("bm.data"
           :base-directory "src/data"
           :publishing-directory "output/doc/data"
           :base-extension "json"
           :publishing-function org-publish-attachment)
          ("bm.assets"
          ...
          ("bm.web"
           ...
           :publishing-directory "output/web"
           :base-extension "html\\|css\\|js\\|png\\|jpg\\|gif\\|ico\\|pdf\\|edn"
           :recursive f
           :publishing-function org-publish-attachment)))
